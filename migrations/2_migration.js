module.exports = async (deployer, networks, accounts) => {
    ...
    deployer.deploy(carAssetContract).then(async (carAssetContract) => {
        ...
        const baseCont = await deployer.deploy(
            baseContract,
            authorizeContractAddress,
            authorizeContractAddress
        )

        const carManagerCont = await deployer.deploy(
            carManagerContract,
            authorizeContractAddress,
            carAssetContractAddress
        )

        const ITVManagerCont = await deployer.deploy(
            iTVManagerContract,
            authorizeContractAddress,
            carAssetContractAddress
        )
